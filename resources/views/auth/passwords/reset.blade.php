...
<body class="bg-pesawat flex justify-center content-center">
    <div class="bg-white flex-col justify-center w-2/5 p-2 py-10 text-center my-16 rounded-lg">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <input class="border-2 border-gray-300 rounded-sm mx-half w-3/4 my-10 p-2 rounded-md" type="password"
            ...
            <div>
                <button class="biru-button text-white font-semibold py-4 w-3/4 text-md rounded-md mt-10 hover:shadow-lg"
                    type="submit" id="submitConfirmPass">
                    Change Password
                </button>
            </div>
        </form>
